    ...
    return notCheckingSession ? Scaffold(
      ...
      body: Center(
        child: SingleChildScrollView(
          child: Padding(
            padding: const EdgeInsets.symmetric(horizontal: 4, vertical: 100),
            child: Column(
                      ...
                      Align(
                        ...
                        child: TextButton(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(color: forgetPasswordColor),
                          ),
                        ),
                      ),
                      SizedBox(height: 20),
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(10), // Adjust this value for squareness
                            ),
